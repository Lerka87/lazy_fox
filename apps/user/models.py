...
class User(AbstractUser):
    about = models.TextField(verbose_name="Про себе", blank=True, null=True)
    ...
    image_tag_thumbnail.short_description = 'Наявний аватар'
    ...
    image_tag.short_description = 'Наявний аватар'